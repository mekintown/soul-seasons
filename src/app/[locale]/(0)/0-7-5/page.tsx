  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center relative">
      ...
      >
        ...
        <p>{t("p1.s5")}</p>
        <br />
        <p className="opacity-40">{t("p1.s6")}</p>
        <p className="opacity-40">{t("p1.s7")}</p>
      </motion.div>
      ...
      <DelayedFullScreenLink href="0-7-6" delay={2000} />
    </div>
  );
};

export default Page0_7_5;
