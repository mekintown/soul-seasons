    ...
    >
      <Shadow>
        ...
        <div className="flex justify-end items-center h-full flex-col">
          <h1 className="font-kanit text-indigo text-[28px] mb-[10px]">คำเตือน</h1>
        </div>
        ...
        <div className="flex justify-end items-center h-full flex-col">
          <MessageBox
            ...
            BoxPadding=" py-5"
            message={
              <div className="flex flex-col text-indigo font-kanit font-light text-[18px] w-[243px] leading-6 space-y-3">
                <p>
        ...
        <div className="flex justify-start items-center h-full flex-col mt-10 ">
          <button
            onClick={HandleClick}
            className="font-kanit font-medium bg-indigo w-[173px] h-[55px] rounded-lg text-white font-cloud font-bold animate-dissolve duration-300 ease-out"
          >
            รับทราบ
          </button>
        </div>
