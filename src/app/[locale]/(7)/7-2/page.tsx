...
const Scene6_3Page2: React.FC = () => {
  const locale = useLocale()

  return (
    <div className="flex h-screen w-full flex-col items-center justify-center">
      <div className="relative z-10 mb-4 aspect-[1916/3408] h-[571px]" id="postcard">
        {true && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{
            ...
            <Image
              src={"/img/results-th/D 7-2-1-1" + ".webp"}
      ...
      {/* <div className="absolute inset-x-0 top-[83%] z-10 m-auto">
        <div className="mb-4 flex justify-center space-x-3">
          <Dialog>
            ...
            <AnimatePresence>{downloadAlert && <DownloadImageAlert />}</AnimatePresence>
          </Dialog>
            ...
            <svg
              ...
              <defs>
                <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                  <use xlinkHref="#image0_1827_7208" transform="scale(0.0104167)" />
                </pattern>
                <image
                  id="image0_1827_7208"
                  width="96"
